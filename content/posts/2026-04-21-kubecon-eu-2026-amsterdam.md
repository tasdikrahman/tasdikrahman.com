...
Putting my notes as is as I put them down while attending the talks
...
- kro.run - platform developer can focus on stiching together the resources together.
  - Instead of the kubebuilder setup
...
I personally was looking forward to attending this talk in person, having worked quite a bit around cluster API and its providers, this one was particularly interesting for me.
...
- cluster API
  ...
  - cluster API does not have opinions on how updates should be performed
...
- life cycle management
  - improve lifecycle management of the node
    - node maintenance
    - graceful shutdown
  ...
  - approach
    ...
    - meaningful states
      - eg: draining
      - what are the meaningful states of the drain operation, for eg: what are we draining in the node
...
Slides: https://hosted-files.sched.co/kccnceu2026/a7/The%20Future%20of%20Kubernetes%20Node%20Lifecycle%20-%20Google%20Slides.pdf

Slides: https://hosted-files.sched.co/kccnceu2026/f3/Improving%20Pod%20Disruption%20and%20Node%20Lifecycle.pdf
...
- operator types
  ...
  - external resource operators
    ...
    - why manual doesn't scale
      ...
      - feature lag
        - k8s support trails behind the atlas API releases
      - inconsistent UX
...
- key takeaways
  ...
  - k8s as an API enables a common architectural layer
...
- experimental promql
  ...
  - type and unit labels {__type__="histogram", __unit__="seconds"}
  - new keywords
    - smoothed
...
I had a great time meeting folks from the community. This time I was also able to meet again in person a lot of cluster API and its providers maintainers, and committers. Great conversations overall with them and also with some of my friends who had traveled back from far. Meeting them was great. In general, I think KubeCon always is amazing as an experience to attend. Looking forward to the next time in Barcelona in 2027.
