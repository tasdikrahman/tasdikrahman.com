...
So it all started with me wanting to update the dependencies of my [Jekyll](https://jekyllrb.com/) website. I started just going with the flow of installing Ruby because I hadn't updated that after I had changed my machine for a bit and I was just practically pushing markdown files for some time. It's also very beautiful that GitHub just allows building such an old Jekyll website. This website is dated from 2015 but I've obviously updated my bundle dependencies and gems. While trying to install this I also got stuck with the old dependency hell loop on Ruby, which I'm familiar with, similar to the Python ecosystem too. Then out of nowhere I started also just searching for what are some more advanced and more recent blogging engines or, if I may say, static website generators. [Hugo](https://gohugo.io/) was on my map for quite a bit.

I had also recently installed Claude Code so I wanted to just give it a spin on my local machine and start using it. I had already been using GitHub Copilot but I feel I was missing out on the whole agentic flow of doing things. That made me look further into the direction of researching a bit further on what other options I had, and Hugo came on top of the list. I think I saw [Zola](https://www.getzola.org/) also as one of the alternatives and a couple more. Given Hugo's huge ecosystem and a couple of my friends also using the same, I decided that it was probably the simplest approach to migrate.

## Migration effort

To be honest I'm very impressed. I started about an hour and a half or somewhere around that to migrate my Jekyll blog and ended up migrating the whole thing and then actually publishing the website in less than, I think, close to two hours from when I started. I'm pretty sure it would have taken me much longer than that to probably migrate if I was sitting at one stretch, which brings me to the point that I feel, for a migration like this, Claude really assisted and accelerated my workflow.
...
I will probably write another post on my current and past AI workflows. As of now I just want to thank deeply the creators of Jekyll for making it so seamless to have allowed me to blog since 2015, from my university days until now. [This is how the blog used to look](https://web.archive.org/web/20250305193726/https://tasdikrahman.com/) before the migration. It marks the end of around close to 11 years of blogging with it. I must say that it was very seamless, apart from the bundle dependency stuff which you would have to deal with. In my honest opinion I think this was probably one of the best decisions that I had made when I started blogging, which allowed me to write as seamlessly as possible and without too many interruptions. Jekyll, I feel, did not really get into the way. I'm looking forward to using Hugo and reading around; it also gives this same seamless experience. I hope to write more this year.
